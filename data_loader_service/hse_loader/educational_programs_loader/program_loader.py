...
def extract_faculty(program_div) -> str:
    faculty_span = program_div.find("span", class_="grey")
    if faculty_span:
        return faculty_span.text.strip().replace("\xa0", " ")
...
def parse_educational_programs_with_faculties() -> dict:
    ...
    if container:
        ...
        for program_div in programs:
            ...
            faculty_name = extract_faculty(program_div)
